    ...
    <div class="feature-work container my-4">
        <div class="row d-flex d-flex align-items-center">
            ...
            <div class="col-lg-6 offset-lg-1 align-left">
                <div class="row">
                    <a class="col" data-type="image" data-fslightbox="gallery" href="./assets/img/works/our-work-01.jpg">
                        <img class="img-fluid" src="./assets/img/works/our-work-03.jpg">
                    </a>
                    <a class="col" data-type="image" data-fslightbox="gallery" href="./assets/img/works/our-work-06.jpg">
                        <img class="img-fluid" src="./assets/img/works/our-work-06.jpg">
                    </a>
                </div>
                <div class="row pt-4">
                    <a class="col" data-type="image" data-fslightbox="gallery" href="./assets/img/works/our-work-05.jpg">
                        <img class="img-fluid" src="./assets/img/works/our-work-05.jpg">
                    </a>
                    <a class="col" data-type="image" data-fslightbox="gallery" href="./assets/img/works/our-work-07.jpg">

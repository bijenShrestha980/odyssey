...
<head>
    <title>Odyssey Nepal - Meet Page</title>
    <meta charset="utf-8">
...
<body>
    ...
    <!-- Start Banner Hero -->
    <div id="meet_single_banner" class="bg-light w-100">
        <div class="container-fluid text-light d-flex justify-content-center align-items-center border-0 rounded-0 p-0 py-5" style="height: 400px">
            <div class="banner-content col-lg-8 m-lg-auto text-center py-5 px-3" style="background: rgb(73 68 68 / 33%); animation: transitionIn 2s;">
                <h1 class="banner-heading h2 pb-5 typo-space-line-center">Meet</<h1>
                </h1>
            </div>
        </div>
    </div>
    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">Meet</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="../assets/img/gallery/meet/1.jpg" alt="Card image cap">
                </div>
            </a>
                ...
                <div id="multi-item-example" class="col-10 carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col">
                                    <a class="templatemo-slide-link" href="../assets/img/gallery/meet/1.jpg">
                                        <img class="img-fluid border rounded" src="../assets/img/gallery/meet/1.jpg" alt="Product Image">
                                    </a>
                                </div>
                                <div class="col">

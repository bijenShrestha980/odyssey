...
<head>
    <title>Odyssey - Contact Page</title>
    <meta charset="utf-8">
...
<section class="container py-5">
    <h1 class="col-12 col-xl-8 h2 text-left text-primary pt-3">Connect with us!</h1>
        ...
        <div class="col-lg-4">
            ...
            <div class="contact row mb-4">
                ...
                <ul class="contact-info list-unstyled col-lg-9 col-9  light-300">
                    ...
                    <li class="text-muted">Mr. Pujan Rai</li>
                    <li class="text-muted">+977 980-8429293</li>
                </ul>
            </div>
            ...
            <div class="contact row mb-4">
                ...
                <ul class="contact-info list-unstyled col-lg-9 col-9 light-300">
                    ...
                    <li class="text-muted">Mr. Yelung Bahing Rai</li>
                    <li class="text-muted">+977 980-8429293</li>
                </ul>
            </div>
